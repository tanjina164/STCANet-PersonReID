...
# ১. পাইথনকে প্রজেক্টের রুট এবং সমস্ত সাব-ফোল্ডারের পাথ নিখুঁতভাবে চিনিয়ে দেওয়া
...
def main():
    ...
    # ৫. কুয়েরি এবং গ্যালারি লোডার তৈরি করা
    ...
    # ৭. অরিজিনাল ডিস্ট্যান্স ম্যাট্রিক্স গণনা
    ...
    # ৮. রি-র‍্যাংকিং অ্যালগরিদম ট্রিগার করা
    ...
    # ফাইনাল ডিস্ট্যান্স ম্যাট্রিক্স সেভ করা
